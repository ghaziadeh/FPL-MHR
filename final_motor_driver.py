...
GPIO.setup(coil_B_2_pin, GPIO.OUT)
class Stepper():
    def __init1__(self,A1,A2,B1,B2,delay,steps):
        self.A1= A1
        self.A2= A2
        self.B1= B1
        self.B2= B2
    ...
    def StepF(self,delay = 0.0055/7,steps = 1000):
        for i in range(0, steps):
            setStep(1,0,1,0)
            time.sleep(delay)
            setStep(0,1,1,0)
    ...
    def stepB(self,delay = 0.0055/7,steps = 1000):
        def setStep(w1, w2, w3, w4):
            GPIO.output(coil_A_1_pin, w1)
            GPIO.output(coil_A_2_pin, w2)
            GPIO.output(coil_B_1_pin, w3)
    ...
    def step_stop(self,delay = 0.0055/7,steps = 1000):
        for i in range(0, steps):
            setStep(0,0,0,0)
            time.sleep(delay)
            setStep(0,0,0,0)
